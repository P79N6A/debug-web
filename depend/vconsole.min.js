  ...
  return (function(e) {
      ...
      var f = o(10),
        ...
        A = (function() {
          function e(t) {
            ...
            if (void 0 !== document) 'complete' == document.readyState ? r() : v['default'].bind(window, 'load', r);
            else {
              var i = void 0,
                l = function s() {
                  document && 'complete' == document.readyState ? (i && clearTimeout(i), r()) : (i = setTimeout(s, 1));
                };
              i = setTimeout(l, 1);
            }
          }
            ...
            i(e, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if (a && a.content) {
                    var i = a.content.match(/initial\-scale\=\d+(\.\d+)?/),
                      l = i ? parseFloat(i[0].split('=')[1]) : 1;
                    l < 1 && (this.$dom.style.fontSize = 13 * r + 'px');
                  }
                ...
                value: function() {
                  ...
                  this.$dom.addEventListener(
                    ...
                    function(e) {
                      if (void 0 === o) {
                        ...
                        (n = t.pageX),
                          (r = t.pageY),
                          (o = e.timeStamp),
                          (i = e.target.nodeType === Node.TEXT_NODE ? e.target.parentNode : e.target);
                      }
                    },
                    !1
                  ),
                    this.$dom.addEventListener('touchmove', function(e) {
                      ...
                      (Math.abs(o.pageX - n) > t || Math.abs(o.pageY - r) > t) && (a = !0);
                    }),
                    this.$dom.addEventListener(
                      'touchend',
                      function(t) {
                        if (a === !1 && t.timeStamp - o < e && null != i) {
                ...
                value: function() {
                  ...
                  v['default'].bind(t, 'touchstart', function(t) {
                    ...
                    v['default'].bind(t, 'touchmove', function(o) {
                      if (o.touches.length > 0) {
                        ...
                        a + t.offsetWidth > document.documentElement.offsetWidth &&
                          ...
                          i + t.offsetHeight > document.documentElement.offsetHeight &&
                            (i = document.documentElement.offsetHeight - t.offsetHeight),
                          a < 0 && (a = 0),
                          i < 0 && (i = 0),
                          (t.style.right = a + 'px'),
                          (t.style.bottom = i + 'px'),
                    ...
                    v['default'].bind(
                      ...
                      function(t) {
                        return (
                          t.target == v['default'].one('.vc-panel') &&
                          void (v['default'].hasClass(e.$dom, 'vc-toggle') || (t.target.style.display = 'none'))
                        );
                      }
                    );
                  ...
                  v['default'].bind(o, 'touchstart', function(e) {
                    ...
                    0 === t
                      ? ((o.scrollTop = 1),
                        0 === o.scrollTop && (v['default'].hasClass(e.target, 'vc-cmd-input') || (n = !0)))
                      : a === r &&
                        ((o.scrollTop = t - 1),
                      ...
                      o &&
                        (d.isString(o)
                          ...
                          : d.isFunction(o.appendTo)
                            ? o.appendTo(r)
                            : d.isElement(o) && r.insertAdjacentElement('beforeend', o)),
                        v['default'].one('.vc-content', t.$dom).insertAdjacentElement('beforeend', r);
                    }),
                        ...
                        for (
                          var n = v['default'].one('.vc-topbar', t.$dom),
                            r = function(t) {
                              ...
                              if (r.data) for (var i in r.data) a.dataset[i] = r.data[i];
                              d.isFunction(r.onClick) &&
                                v['default'].bind(a, 'click', function(t) {
                                  var o = r.onClick.call(a);
                                  o === !1 ||
                                    (v['default'].removeClass(v['default'].all('.vc-topbar-' + e.id), 'vc-actived'),
                      ...
                      if (o)
                        for (
                          var n = v['default'].one('.vc-tool-last', t.$dom),
                            r = function(t) {
                              var r = o[t],
                                a = v['default'].render(x['default'], {name: r.name || 'Undefined', pluginID: e.id});
                              1 == r.global && v['default'].addClass(a, 'vc-global-tool'),
                                d.isFunction(r.onClick) &&
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  if ((t.trigger('remove'), this.isInited)) {
                    ...
                    for (var n = v['default'].all('.vc-topbar-' + e, this.$dom), r = 0; r < n.length; r++)
                      n[r].parentNode.removeChild(n[r]);
                    var a = v['default'].one('#__vc_log_' + e);
                    a && a.parentNode.removeChild(a);
                    for (var i = v['default'].all('.vc-tool-' + e, this.$dom), l = 0; l < i.length; l++)
                ...
                value: function(e) {
                  if (this.isInited) {
                    ...
                    v['default'].removeClass(v['default'].all('.vc-toptab', this.$dom), 'vc-toggle'),
                      ...
                      o.length > 0
                        ? v['default'].addClass(v['default'].one('.vc-content', this.$dom), 'vc-has-topbar')
                        : v['default'].removeClass(v['default'].one('.vc-content', this.$dom), 'vc-has-topbar'),
    ...
    function(e, t) {
      ...
      function o(e) {
        ...
        return (
          c < 100 && (c = '0' + c), {time: +t, year: r, month: n, day: o, hour: a, minute: i, second: l, millisecond: c}
        );
      }
      function n(e) {
      ...
      function d(e) {
        return !(
          ...
          (n(e) || r(e) || i(e) || a(e) || c(e) || u(e) || l(e) || s(e))
        );
      }
      function u(e) {
      ...
      function b(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '\t',
          o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 'CIRCULAR_DEPENDECY_OBJECT',
          n = [],
          r = JSON.stringify(
            e,
            function(e, t) {
          ...
          (e.i = function(t, o) {
            ...
            for (r = 0; r < t.length; r++) {
              ...
              ('number' == typeof i[0] && n[i[0]]) ||
                (o && !i[2] ? (i[2] = o) : o && (i[2] = '(' + i[2] + ') and (' + o + ')'), e.push(i));
            }
          }),
          e
        );
    ...
    function(e, t, o) {
      function n(e, t) {
        for (var o = 0; o < e.length; o++) {
          ...
          if (r) {
            ...
            for (var i = [], a = 0; a < n.parts.length; a++) i.push(s(n.parts[a], t));
            f[n.id] = {id: n.id, refs: 1, parts: i};
          }
        }
      }
      function r(e) {
      ...
      function s(e, t) {
        ...
        if (t.singleton) {
          var a = m++;
          (o = g || (g = l(t))), (n = d.bind(null, o, a, !1)), (r = d.bind(null, o, a, !0));
        } else
          e.sourceMap &&
          'function' == typeof URL &&
            ...
            c(t, [
              {
                ...
                value: function() {
                  var e = this;
                  s(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'onReady', this).call(this),
              ...
              },
              {
                key: 'mockConsole',
                value: function() {
                  s(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'mockConsole', this).call(this);
                  var e = this;
                  f.isFunction(window.onerror) && (this.windowOnError = window.onerror),
                    (window.onerror = function(t, o, n, r, a) {
                      var i = t;
                      o && (i += '\n' + o.replace(location.origin, '')), (n || r) && (i += ':' + n + ':' + r);
                      var l = !!a && !!a.stack,
                        c = (l && a.stack.toString()) || '';
                      e.printLog({logType: 'error', logs: [i, c], noOrigin: !0}),
                        f.isFunction(e.windowOnError) && e.windowOnError.call(window, t, o, n, r, a);
                    });
                },
              },
              {
                ...
                value: function(e) {
                  ...
                  (r.innerHTML = t), r.setAttribute('nonce', n), document.documentElement.appendChild(r);
                  var a = window.__vConsole_cmd_result,
                    i = window.__vConsole_cmd_error;
                  if ((document.documentElement.removeChild(r), 0 == i)) {
                    var l = void 0;
          ...
          return (
            ...
            s(t, [
              ...
              },
              {
                key: 'onAddTopBar',
                value: function(e) {
                  for (var t = this, o = ['All', 'Log', 'Info', 'Warn', 'Error'], n = [], r = 0; r < o.length; r++)
                    n.push({
                      name: o[r],
                      ...
                      onClick: function() {
                        return (
                          !f['default'].hasClass(this, 'vc-actived') && void t.showLogType(this.dataset.type || 'all')
                        );
                      },
                    });
              ...
              },
              {
                ...
                value: function() {
                  ...
                  f['default'].bind(t, 'click', function(o) {
                    ...
                    f['default'].removeClass(r, 'vc-log-partly-log'),
                      f['default'].removeClass(r, 'vc-log-partly-info'),
                      f['default'].removeClass(r, 'vc-log-partly-warn'),
                      f['default'].removeClass(r, 'vc-log-partly-error'),
                      'all' == n
                        ? f['default'].removeClass(r, 'vc-log-partly')
                        : (f['default'].addClass(r, 'vc-log-partly'), f['default'].addClass(r, 'vc-log-partly-' + n));
                  });
                ...
                value: function(e) {
                  ...
                  f['default'].removeClass(t, 'vc-log-partly-log'),
                    ...
                    'all' == e
                      ...
                      : (f['default'].addClass(t, 'vc-log-partly'), f['default'].addClass(t, 'vc-log-partly-' + e));
                },
              },
              {
                key: 'scrollToBottom',
                ...
                value: function(e) {
                  ...
                  if (t.length || e.content) {
                    ...
                    if ((u.isString(t[0]) && ((t[0] = t[0].replace(n, '')), '' === t[0] && t.shift()), !e.meta)) {
                      var i = u.getDate(e.date);
                      e.meta = i.hour + ':' + i.minute + ':' + i.second;
                    }
                    for (
                  ...
                  return (
                    f['default'].bind(f['default'].one('.vc-fold-outer', a), 'click', function(t) {
                      ...
                      if (0 == n.children.length && e) {
                        for (var r = u.getObjAllKeys(e), i = 0; i < r.length; i++) {
                          var l = e[r[i]],
                            c = 'undefined',
                            s = '';
                          u.isString(l)
                          ...
                          if (u.isArray(l)) {
                            ...
                            d = o.getFoldedLine(
                              ...
                              f['default'].render(
                                w['default'],
                                {key: r[i], keyType: s, value: v, valueType: 'array'},
                                !0
                              )
                            );
                            ...
                            d = o.getFoldedLine(
                              ...
                              f['default'].render(
                                w['default'],
                                {key: u.htmlEncode(r[i]), keyType: s, value: p, valueType: 'object'},
                                !0
                              )
                            );
                          } else {
                            e.hasOwnProperty && !e.hasOwnProperty(r[i]) && (s = 'private');
                            var h = {
                              lineType: 'kv',
                              key: u.htmlEncode(r[i]),
                              keyType: s,
                        ...
                        if (u.isObject(e)) {
                          ...
                          (g = u.isObject(b)
                            ? o.getFoldedLine(
                                ...
                                f['default'].render(
                                  w['default'],
                                  {key: '__proto__', keyType: 'private', value: u.getObjName(b), valueType: 'object'},
                                  !0
                                )
                              )
            ...
            c(t, [
              {
                key: 'onInit',
                value: function() {
                  s(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), 'onInit', this).call(this),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  (t = 'Unknown'),
                    l && l[1]
                      ? ((t = l[1]), (i += ', WeChat ' + t), console.info('[system]', 'System:', i))
                      : console.info('[system]', 'System:', i),
                    (t = 'Unknown'),
                    (t =
                  ...
                  (t = 'Unknown'),
                    c && c[0]
                      ? ((c = c[0].split('/')), (t = c[1]), (i += ', ' + t), console.info('[system]', 'Network:', i))
                      : console.info('[system]', 'Protocol:', i),
                    ...
                    d['default'].delegate(
                      ...
                      function(t) {
                        ...
                        d['default'].hasClass(n, 'vc-actived')
                          ? (d['default'].removeClass(n, 'vc-actived'), e.updateRequest(o, {actived: !1}))
                          : (d['default'].addClass(n, 'vc-actived'), e.updateRequest(o, {actived: !0})),
                          t.preventDefault();
                      }
                    );
                  ...
                  if (((this.reqList[e] = n), this.isReady)) {
                    ...
                    n.status >= 400 &&
                      ...
                      c
                        ...
                        : d['default'].one('.vc-log', this.$tabbox).insertAdjacentElement('beforeend', l),
                      (this.domList[e] = l);
                    ...
                    (t._open = o),
                      ...
                      (window.XMLHttpRequest.prototype.open = function() {
                        var e = this,
                          ...
                          i = t.getUniqueID(),
                          l = null;
                        (e._requestID = i), (e._method = r), (e._url = a);
                        var c = e.onreadystatechange || function() {},
                          s = function() {
                            ...
                            if (
                              ...
                              o.header = {};
                              for (
                                var n = e.getAllResponseHeaders() || '', r = n.split('\n'), a = 0;
                                a < r.length;
                                a++
                              ) {
                                var s = r[a];
                              ...
                              3 == e.readyState ||
                                (4 == e.readyState
                                  ...
                                  : clearInterval(l));
                            return e._noVConsole || t.updateRequest(i, o), c.apply(e, arguments);
                          };
                      ...
                      (window.XMLHttpRequest.prototype.send = function() {
                        ...
                        var i = e._url.split('?');
                        if (((a.url = i.shift()), i.length > 0)) {
                          (a.getData = {}), (i = i.join('?')), (i = i.split('&'));
                          var l = !0,
                            c = !1,
                            s = void 0;
                          try {
                        ...
                        if ('POST' == a.method)
                          ...
                          } else v.isPlainObject(r) && (a.postData = r);
            ...
            c(t, [
                        ...
                        onClick: function(e) {
                          t.activedElem &&
                            (g['default'].hasClass(t.activedElem, 'vc-toggle')
                              ? g['default'].one('.vcelm-node', t.activedElem).click()
                              : t.activedElem.parentNode &&
                                g['default'].hasClass(t.activedElem.parentNode, 'vcelm-l') &&
                                g['default'].one('.vcelm-node', t.activedElem.parentNode).click());
                        },
                      },
                    ];
                  e(o);
              ...
              },
              {
                ...
                value: function(e, t, o) {
                  var n = this,
                    r = new p['default'](e).get();
                  switch (
                    ((e.view = r),
                    g['default'].delegate(r, 'click', '.vcelm-node', function(t) {
                      t.stopPropagation();
                      ...
                      if (!g['default'].hasClass(o, 'vcelm-noc')) {
                        ...
                        for (var r = -1, a = 0; a < o.children.length; a++) {
                          var i = o.children[a];
                          g['default'].hasClass(i, 'vcelm-l') &&
                            (r++,
                            i.children.length > 0 ||
                              (e.childNodes[r]
                                ? n.renderView(e.childNodes[r], i, 'replace')
            ...
            s(e, [
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  var r = b['default'].render(u['default'], {node: e}),
                    a = b['default'].render(f['default'], {node: e});
                  if (n) b['default'].addClass(t, 'vcelm-noc'), t.appendChild(r), o || t.appendChild(a);
                  else {
                    t.appendChild(r);
          ...
          return (
            ...
            c(t, [
              ...
              },
              {
                key: 'onAddTopBar',
                value: function(e) {
                  for (var t = this, o = ['Cookies', 'LocalStorage'], n = [], r = 0; r < o.length; r++)
                    n.push({
                      name: o[r],
                      data: {type: o[r].toLowerCase()},
                      className: '',
                      onClick: function() {
                        return (
                          !m['default'].hasClass(this, 'vc-actived') &&
                ...
                value: function() {
                  ...
                  for (var e = [], t = document.cookie.split(';'), o = 0; o < t.length; o++) {
                    var n = t[o].split('='),
                      r = n[0].replace(/^ /, ''),
                      a = n[1];
                    e.push({name: decodeURIComponent(r), value: decodeURIComponent(a)});
                  }
                  return e;
                },
              },
